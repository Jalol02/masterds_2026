...
workspace_name = "Mastersds2026" # PLACEHOLDER
subscription_id = "9f37719f-c7ee-4861-a359-bac1e12202bd" # PLACEHOLDER
resource_group = "ahmedov.jalol-rg" # PLACEHOLDER
experiment_name = "auto-price" # PLACEHOLDER
iteration = "284"  # PLACEHOLDER
run_id = "auto-mobile_ml_284"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/auto-price','subscription_id':'9f37719f-c7ee-4861-a359-bac1e12202bd','resource_group':'ahmedov.jalol-rg','workspace_name':'Mastersds2026','iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','IsImageTask':False,'IsTextDNNTask':False,'validation_size':0.2,'test_size':0.1,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':30,'enforce_time_on_windows':False,'experiment_timeout_minutes':360,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':None,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':False,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'minimize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_E4d_v4','vm_priority':'dedicated','label_column_name':'price','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"MaxAbsScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"ExtraTreesRegressor\", \"module\": \"sklearn.ensemble\", \"param_args\": [], \"param_kwargs\": {\"bootstrap\": true, \"criterion\": \"squared_error\", \"max_features\": 0.2, \"min_samples_leaf\": 0.0028629618034842247, \"min_samples_split\": 0.008991789964660124, \"n_estimators\": 25}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"207dd0cf93448a12a4fb4f8b7c940e27b2aadc5d\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ MaxAbsScaler, ExtraTreesRegressor }\"}" # PLACEHOLDER
pipeline_id = "207dd0cf93448a12a4fb4f8b7c940e27b2aadc5d" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/eastus2/workspaces/a7932d4e-5a8d-4c40-8315-021fb8236987/data/auto_prices/versions/1\",\"ResolvedUri\":\"azureml://locations/eastus2/workspaces/a7932d4e-5a8d-4c40-8315-021fb8236987/data/auto_prices/versions/1\",\"AssetId\":\"azureml://locations/eastus2/workspaces/a7932d4e-5a8d-4c40-8315-021fb8236987/data/auto_prices/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
